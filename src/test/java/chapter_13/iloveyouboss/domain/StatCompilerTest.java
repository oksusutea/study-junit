 ...
 ***/
package chapter_13.iloveyouboss.domain;

import static org.junit.Assert.*;

import chapter_13.iloveyouboss.controller.QuestionController;
import java.util.*;
...
public class StatCompilerTest {
    ...
    public void responsesByQuestionAnswersCountsByQuestionText() {
        ...
        Map<String, Map<Boolean, AtomicInteger>> responses = stats
